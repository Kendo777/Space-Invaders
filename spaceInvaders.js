...
function setInitialPositions(){
	...
	playArea.style.width = window.innerWidth/2-margin*2+"px";
	...
	info.style.width = window.innerWidth/4-margin*2+"px";
	info.style.height = window.innerHeight-margin*3+"px";
...
function getDOMReferences(){
	...
	info = document.getElementById("infoArea");
